...
// Prepare prepare post data before inserting
func (p *Post) Prepare() {
	p.ID = 0
...
// Validate for validating post data
...
// SavePost insert single post data in Db
...
// FindAllPosts fetch all posts from DB
...
// FindPostByID fetch single post by id
...
// UpdatePost updating single post data
...
// DeletePost remove single post from db
